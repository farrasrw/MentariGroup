		...
		init : function(){ 
			...
			if(this.feeds['twitter_arr']) {
				...
				for(var i = 0; i < this.feeds['twitter_arr'].length; i++) {
					this.feeds['twitter_url'][i] = 'http://localhost/Trolo/js/dpSocialTimeline/twitter_oauth/user_timeline.php?screen_name='+$.trim(this.feeds['twitter_arr'][i])+'&t='+new Date().getTime();
				}
			...
			if(this.feeds['twitter_hash_arr']) {
				for(var i = 0; i < this.feeds['twitter_hash_arr'].length; i++) {
					this.feeds['twitter_hash_url'][i] = 'http://localhost/Trolo/js/dpSocialTimeline/twitter_oauth/user_timeline.php?screen_name='+$.trim(this.feeds['twitter_hash_arr'][i])+'&t='+new Date().getTime();
				}
