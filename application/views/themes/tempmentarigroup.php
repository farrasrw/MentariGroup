<html>
    ...
    <head>
        ...
        $(document).ready(function() {
            ...
            $('.btnuser-syarat').on('click', function(){
        ...
        <style>
            ...
            .background-footer{
               /* background-image: url("<?php echo base_url(); ?>style/images/footer.jpg");
                background-repeat: repeat;*/
                border-top: 8px solid #fbb41c;
                background-size: auto 150%;
                background-color: #066a2a;
            }
                ...
                <nav class="navbar navbarMenu" role="navigation">
                    ...
                    <div class="logo col-md-6 col-xs-13 col-sm-7 text-left">
                        <a href="<?php echo base_url(); ?>">
                            <img class="img-responsive" src="<?php echo base_url();?>style/images/logomentari.png">
                        </a>
                    </div>
                    <div class="col-md-16 col-sm-23 col-xs-24 fontOswald font18 NavMainMenu hidden-xs" >
                            ...
                            <ul id="navMain" class="nav navbar-nav fontAvenir" >
                                ...
                                <li class="noborder"><a href="<?php echo base_url(); ?>"><span>BERANDA</span></a></li>

                                <li class="dropdown menudropdown">
                                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span>TENTANG KAMI</span></a>

                                  <ul class="dropdown-menu subMenu fontRoboto" style="background-color:white">
                                    <li class="liMenu ">
                                        <div class="row menuCaption">
                                        <span class="fontRoboto font18">TENTANG KAMI</span><span onclick="hidemenu(true);" class="closemenu">X</span>
                                        <hr style="margin:0px; margin-top:10px">
                                    </div>
                                    <ul class="menuItem">
                                        <li style="height:40%;">
                                            <p><a href='<?php echo base_url(); ?>aboutus/latar-belakang'>Latar belakang</a></p>
                                            <p><a href='<?php echo base_url(); ?>home/visimisi'>Visi & Misi</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>aboutus/nilai-perusahaan'>Nilai perusahaan</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>aboutus/struktur-organisasi'>Struktur Organisasi</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>home/dewanholding'>Dewan & Holding</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>aboutus/anak-perusahaan'>Anak Perusahaan</a></p>                                        
                                        </li>
                                    </ul>
                                    </li>
                                  </ul>
                                ...
                                <li class="dropdown menudropdown">
                                  <a href="<?php echo base_url(); ?>home/nopage" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span>BISNIS KAMI</span></a>

                                  <ul class="dropdown-menu subMenu fontRoboto" style="background-color:white">
                                    <li class="liMenu ">
                                        <div class="row menuCaption">
                                        <span class="fontRoboto font18">BISNIS KAMI</span><span onclick="hidemenu(true);" class="closemenu">X</span>
                                        <hr style="margin:0px; margin-top:10px">
                                    </div>
                                    <ul class="menuItem">
                                        <li style="height:40%;">
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>PT Mentari Agung Jaya Usaha</a></p>
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>PT Mentari Alam Jaya Utama</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>PT Risman Scham Palm Indonesia</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>PT Sakti Mait Jaya Langit</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>PT Grahacipta Banko  Jaya</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>PT Mentari Laju Jaya Usaha</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>PT Mentari Sinar Mitra Alam</a></p>                                        
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>PT Mentari Mitra Alam Jaya</a></p>                                        
                                        </li>
                                    </ul>
                                    </li>
                                  </ul>
                                ...
                                <li class="dropdown menudropdown">
                                  <a href="<?php echo base_url(); ?>home/nopage" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span>KEGIATAN</span></a>

                                  <ul class="dropdown-menu subMenu fontRoboto" style="background-color:white">
                                    <li class="liMenu ">
                                        <div class="row menuCaption">
                                        <span class="fontRoboto font18">KEGIATAN</span><span onclick="hidemenu(true);" class="closemenu">X</span>
                                        <hr style="margin:0px; margin-top:10px">
                                    </div>
                                    <ul class="menuItem">
                                        <li style="height:40%;">
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>Galeri</a></p>
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>CSR</a></p>
                                        </li>
                                    </ul>
                                    </li>
                                  </ul>
                                ...
                                <li class="dropdown menudropdown">
                                  <a href="<?php echo base_url(); ?>home/nopage" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span>HUBUNGI KAMI</span></a>

                                  <ul class="dropdown-menu subMenu fontRoboto" style="background-color:white">
                                    <li class="liMenu ">
                                        <div class="row menuCaption">
                                        <span class="fontRoboto font18">HUBUNGI KAMI</span><span onclick="hidemenu(true);" class="closemenu">X</span>
                                        <hr style="margin:0px; margin-top:10px">
                                    </div>
                                    <ul class="menuItem">
                                        <li style="height:40%;">
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>Kantor (Site Map)</a></p>
                                            <p><a href='<?php echo base_url(); ?>home/nopage'>Pabrik (Site Map)</a></p>
                                        </li>
                                    </ul>
                                    </li>
                                  </ul>
                                ...
                                <li class="noborder"><a href="<?php echo base_url(); ?>home/nopage"><span>HUBUNGAN INVESTOR</span></a></li>
	...
	<div class="container-fluid">
            <div class="row background-footer" style="height: 180px;">
                <div class="container">
                    
                    <div class="row div-all-right font12">
                        <div class="col-xs-24 text-center">
                           <br>
                            <p><span class="font18-md font16-xs text-bold text-white">GRAHA MENTARI</span></p>
                            <p><span class="font14-md font12-xs text-white">JL. CIPUTAT NO 14, KEBAYORAN LAMA, JAKARTA SELATAN 12240 - INDONESIA</span></p>
                            <p><span class="font14-md font12-xs text-white">PHONE : (+62-21) 27515827 FAX : (+62-21) 27515675</span></p>
                            <p><span class="font14-md font12-xs text-bold text-white">@2017 MENTARI GROUP</span></p>
